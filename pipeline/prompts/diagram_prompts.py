...
GENERATE_DIAGRAM_TOPICS_PROMPT_ = """You are an expert in diagram design and have a broad knowledge of different topics.
...
GENERATE_DIAGRAM_DATA_JSON_PROMPT_ = """You are an expert in diagram design and have broad knowledge about various topics.
My persona is: "{persona}"
...
4. The text for each node/edge should be concise and not too long, which can be easily understood by the viewers.
5. All elements must be in English, even if the persona is non-English.
6. Translate all elements into Japanese. Return only the result.
Please provide the elements in JSON format without additional text at the beginning or end."""


GENERATE_DIAGRAM_QA_PROMPT_ = """You are an expert in data analysis and good at asking questions about diagrams.
My persona is: "{persona}"
...
GENERATE_DIAGRAM_CODE_GRAPHVIZ_PROMPT_ = """You are an expert in graph design and good at writing code (Python `graphviz`) to generate diagrams.
My persona is: "{persona}"
